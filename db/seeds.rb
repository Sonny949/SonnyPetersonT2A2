...
trailers = Category.create(name: 'Trailers')
...
post_one.image.attach(io: File.open(Rails.root.join("app", "assets", "images", "oxygen_thief.jpg")), filename: 'oxygen_thief.jpg' , content_type: "image/jpg")
...
post_three.image.attach(io: File.open(Rails.root.join("app", "assets", "images", "shestheculpritii.jpg")), filename: 'shestheculpritii.jpg' , content_type: "image/jpg")
